...
Java_com_actor_testapplication_utils_CCallJava_callVoid(JNIEnv *env, jobject instance) {
    //一直写到class,不写方法名称
    jclass clazz = (*env)->FindClass(env, "com/actor/testapplication/utils/CCallJava");
 ...
 */
JNIEXPORT void JNICALL
Java_com_actor_testapplication_utils_CCallJava_staticMethodCalledVoid(JNIEnv *env, jclass type) {
    jclass clazz = (*env)->FindClass(env, "com/actor/testapplication/utils/CCallJava");
