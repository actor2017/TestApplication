...
import com.actor.myandroidframework.utils.database.MigrationHelper;
 ...
 *   @see Property[] = {@link AbstractDao#getProperties()}
 *
 *   @see WhereCondition = {@link Property#eq(Object)} //相等
 *   @see WhereCondition = {@link Property#notEq(Object)} //不相等
 *   @see WhereCondition = {@link Property#notEq(Object)} //不相等
 *   @see WhereCondition = {@link Property#like(String)} //模糊查询, string要用夹在%key%中间, 例: Properties.FirstName.like("%doris%"), 查询FristName包含doris的人
 *   @see WhereCondition = {@link Property#gt(Object)} //大于
 *   @see WhereCondition = {@link Property#lt(Object)} //小于
 *   @see WhereCondition = {@link Property#ge(Object)} //大于等于
 *   @see WhereCondition = {@link Property#le(Object)} //小于等于
 *   @see WhereCondition = {@link Property#between(Object, Object)} //小于等于
 *   @see WhereCondition = {@link Property#in(Object...)} //在给出的value的范围内的符合项
 *   @see WhereCondition = {@link Property#in(Collection)} //在给出的value的范围内的符合项
 *   @see WhereCondition = {@link Property#notIn(Object...)} //不在给出的value的范围内的符合项
 *   @see WhereCondition = {@link Property#notIn(Collection)} //不在给出的value的范围内的符合项
 *   @see WhereCondition = {@link Property#isNull()} //为空
 *   @see WhereCondition = {@link Property#isNotNull()} //不为空
 *   ...
 *
 *   //2. 获取 QueryBuilder
 ...
 */
@Deprecated
public class GreenDaoUtils12 {

    protected static GreenDaoUtils12      instalce;
    ...
    @SafeVarargs
    public static void init(Context context, boolean isDebug, String dbName, Class<? extends AbstractDao<?, ?>>... daoClasses) {
        if (instalce == null) instalce = new GreenDaoUtils12(context, isDebug, dbName, daoClasses);
    }
     ...
     * @param dbName 数据库名称(没有就创建), my_database
     *               或读取已有数据库例: xxx.db. 注意: 读取已有数据库时, 要保证这个这个已有数据库的目录: context.getDatabasePath()
     * @param daoClasses 数据库表对应的实体(ItemEntity.java)的dao, 示例:
     *                   ItemEntityDao.class(由'Build -> Make Project'生成), ...
     */
    @SafeVarargs
    protected GreenDaoUtils12(Context context, boolean isDebug, String dbName, Class<? extends AbstractDao<?, ?>>... daoClasses) {
