...
import com.actor.testapplication.databinding.ActivityNovelSpiderBinding;
import com.actor.testapplication.novel.BaiDuNovelFinder;
import com.actor.testapplication.novel.BaseNovelFinder;
import com.actor.testapplication.novel.BingNovelFinder;
import com.actor.testapplication.novel.OnFindElementsListener;
import com.actor.testapplication.novel.OnParseElementsListener;
import com.actor.testapplication.utils.Global;
import com.actor.testapplication.utils.NovelUtils;
                ...
                if (isNoEmpty(itilNovelName, itilPage)) {
                    ...
                    switch (islEngineType.getSelectedItemPosition()) {
                        ...
                        case 1:
                            ...
                            break;
                        default:
                            ToasterUtils.warning("该引擎暂未实现搜索功能!");
                            break;
                    }
                }
                break;
...
//                    NovelUtils.showAllDb(DAO);
                ...
                public void onFail(Throwable t) {
                    dismissNetWorkLoadingDialog();
                    ToasterUtils.errorFormat("解析出错: %s", t);
                }
            });
        }
        @Override
        ...
        public void onFail(Throwable t) {
            dismissNetWorkLoadingDialog();
            ToasterUtils.errorFormat("查找失败: %s", t);
        }
    }
        ...
        if (isSearchResultData) {
            ...
            if (URLS.isEmpty()) {
                ...
                for (Map.Entry<String, String> entry : URLS.entrySet()) {
                    ...
                    sb.append(url);
                    sb.append("\n");
                    LogUtils.errorFormat("url = %s, webName = %s", url, webName);
                }
            }
        }
